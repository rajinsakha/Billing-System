...
const Logout = () => {
  ...
  return (
    <Dialog>
      <DialogTrigger>
        <>
          <Button className="flex items-center gap-3 rounded-lg  py-2 text-muted-foreground transition-all bg-transparent hover:text-white hover:bg-primary w-[200px] justify-start">
